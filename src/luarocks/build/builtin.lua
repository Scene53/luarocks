...
function builtin.get_default_build_config(rockspec, libs)
    local build = {}
    build.type = "builtin"
    ...
    build.modules, build.install, build.copy_directories = builtin.autodetect_modules(libs, incdirs, libdirs)
