...
-- @param merge_to_cached_manifest boolean: 'true' will merge created manifest to cached one
-- @return boolean or (nil, string): True if manifest was generated,
-- or nil and an error message.
function writer.make_manifest(repo, deps_mode, remote, merge_to_cached_manifest)
