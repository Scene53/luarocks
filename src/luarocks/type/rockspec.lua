...
local rockspecs_to_build_system = {
    ["4.0"] = "purelua",
    deafult = "builtin"
}
local rockspec_formats, versions = type_check.declare_schemas({
        ...
        ["4.0"] = {
            build = {
                ...
                file_name_restrections = {
                    _any = {
                        _type = "string",
                        _mandatory = false,
                    }
                },
                install_files_in_package_dir = { _type = "boolean" }
            },
            dependencies = {
                _any = {
                    -- this pattern must allow dependency like this "casino-machine 1.0.0" ...
...
type_rockspec.order = {"rockspec_format", "package", "version", 
    ...
    { "build", {"type", "modules", "copy_directories", "platforms","dir_name_restrections", "file_name_restrections", "install_files_in_package_dir"} },
...
--- this function returns the default build system for this rockspec format
function type_rockspec.default_build_system(rockspec_format)
    local build_system = rockspecs_to_build_system[rockspec_format] or rockspecs_to_build_system[deafult]
    return build_system
end
